        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 flex items-center">
              ...
              Select Entry to Generate Agreement
            </h3>
            <button
                ...
                >
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{entry.assetName}</p>
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-500 mb-1">
                        Asset ID
                      </label>
                      <p className="font-medium text-gray-900">{entry.assetId}</p>
                    </div>
                  </div>
                </div>
              ))
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="font-medium text-gray-900">Expected CSV Format:</span>
        </div>
